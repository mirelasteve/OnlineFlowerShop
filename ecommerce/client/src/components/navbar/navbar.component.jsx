    ...
    renderNavEnd(){
        if(this.props.currentUser === null){
            return ( <React.Fragment>
                ...
                < div className='navbar-item'><button onClick={()=>SignInWithGoogle()} className='button is-danger is-light'><span className='icon is-large'><i className="fab fa-google" aria-hidden="true"></i></span></button></div>
            </React.Fragment>)
            ...
            return ( <React.Fragment>
                ...
                <div className='navbar-item'>{this.props.currentUser.displayName}</div>
                <div className='navbar-item'>
                    <button className='button is-danger is-outlined' onClick={()=>SignOut()}>Sign Out</button>
                </div>
            </React.Fragment>)
        }
    }
